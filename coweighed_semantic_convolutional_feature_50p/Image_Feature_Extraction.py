...
from coweighed_semantic_convolutional_feature_50p.Spacial_Matrix_Determination import extract_mask_for_an_image
from coweighed_semantic_convolutional_feature_50p.Spacial_Weight_Determination import get_Omega_for_an_image
from coweighed_semantic_convolutional_feature_50p.Channel_Weight_Determination import get_normalized_beta_for_an_image
from coweighed_semantic_convolutional_feature_50p.PCA_Whitening import apply_pca_whitening
import numpy as np
import pandas as pd
...
def extract_feature_vector(image_filename, dataset) :
    ...
    if dataset == "Oxford5k" :
        param_file_path = 'coweighed_semantic_convolutional_feature_50p\\Oxford5k\\parameters.xlsx'
        pca_transformation_matrix_path = 'coweighed_semantic_convolutional_feature_50p\\Oxford5k\\pca_transformation_matrix.csv'
        pca_explained_variance_path = 'coweighed_semantic_convolutional_feature_50p\\Oxford5k\\pca_explained_variance.csv'
        feature_mean_path = 'coweighed_semantic_convolutional_feature_50p\\Oxford5k\\feature_mean.csv'
        channel_frequency_path = 'coweighed_semantic_convolutional_feature_50p\\Oxford5k\\channel_frequency_map.csv'

    if dataset == "Paris6k" :
        param_file_path = 'coweighed_semantic_convolutional_feature_50p\\Paris6k\\parameters.xlsx'
        pca_transformation_matrix_path = 'coweighed_semantic_convolutional_feature_50p\\Paris6k\\pca_transformation_matrix.csv'
        pca_explained_variance_path = 'coweighed_semantic_convolutional_feature_50p\\Paris6k\\pca_explained_variance.csv'
        feature_mean_path = 'coweighed_semantic_convolutional_feature_50p\\Paris6k\\feature_mean.csv'
        channel_frequency_path = 'coweighed_semantic_convolutional_feature_50p\\Paris6k\\channel_frequency_map.csv'

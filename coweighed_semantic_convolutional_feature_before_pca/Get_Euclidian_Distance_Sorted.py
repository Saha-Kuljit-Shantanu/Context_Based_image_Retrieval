...
# filename = 'image_features_with_pca.csv'

Oxford5k_file = 'coweighed_semantic_convolutional_feature_before_pca\\Oxford5k\\image_features.csv'
Paris6k_file = 'coweighed_semantic_convolutional_feature_before_pca\\Paris6k\\image_features.csv'

...
from coweighed_semantic_convolutional_feature_before_pca.Spacial_Matrix_Determination import extract_mask_for_an_image
from coweighed_semantic_convolutional_feature_before_pca.Spacial_Weight_Determination import get_Omega_for_an_image
from coweighed_semantic_convolutional_feature_before_pca.Channel_Weight_Determination import get_normalized_beta_for_an_image
...
def extract_feature_vector(image_filename, dataset) :
    ...
    if dataset == "Oxford5k" :   
        param_file_path = 'coweighed_semantic_convolutional_feature_before_pca\\Oxford5k\\parameters.xlsx'

    if dataset == "Paris6k" :   
        param_file_path = 'coweighed_semantic_convolutional_feature_before_pca\\Paris6k\\parameters.xlsx'
    # pca_transformation_matrix_path = 'pca_transformation_matrix.csv'
    # pca_explained_variance_path = 'pca_explained_variance.csv'
    # feature_mean_path = 'feature_mean.csv'

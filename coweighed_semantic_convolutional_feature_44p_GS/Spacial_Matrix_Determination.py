import numpy as np
import cv2
from coweighed_semantic_convolutional_feature_44p_GS.Extract_Feature_Map import get_feature_map
...
def extract_mask_for_an_image(desired_layer_output, channel_frequency_map, zero_fmap):
    
    max_frequent_channel_feature_map = get_feature_map(desired_layer_output, channel_frequency_map, zero_fmap)

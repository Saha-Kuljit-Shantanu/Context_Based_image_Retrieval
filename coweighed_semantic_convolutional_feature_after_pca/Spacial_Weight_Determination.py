import numpy as np
from coweighed_semantic_convolutional_feature_after_pca.Extract_Feature_Map import get_feature_map
...
def get_Spatial_Weight_for_an_image(num_channels, desired_layer_output, I):
    ...
    for channel_index in range( 0, num_channels ):
        ...
        X = get_feature_map(desired_layer_output,channel_index)
        #X = np.dot(X,I)
        X = X * I
        S_i = S_i + X
